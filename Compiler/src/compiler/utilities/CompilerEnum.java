...
public class CompilerEnum {
	...
	public static enum TokenType {
		...
		ID, INTEGER, FLOAT, KEYWORD, EQLTO, NOTEQL, LTHEN, GTHEN, LEQL, GEQL, SEMICOL, COMMA, DOT, COL, DBLCOL, PLUS, MINUS, STAR, FSLASH, EQL, LPAREN, RPAREN, LCURL, RCURL, LSQR, RSQR
	}
